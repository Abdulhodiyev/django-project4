    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='blogs.blogauthormodel')),
                ('categories', models.ManyToManyField(related_name='blogs', to='blogs.blogcategorymodel')),
                ('tags', models.ManyToManyField(related_name='tag', to='blogs.blogtagmodel')),
            ],
            options={
                'verbose_name': 'blog',
